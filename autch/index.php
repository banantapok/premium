...
if (isset($_SESSION['user_data'])) {
	header("Location: /colo/colo.html");
	exit();
}
...
<body class="bg-dark">
				...
				<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
					<form class="form w-100" method="post">
						<div class="text-center mb-10">
							<h1 class="text-light mb-3">BananTap Premium</h1>
						</div>
						...
						<div class="fv-row mb-10">
							...
							<div class="fv-row mb-6">
								<div class="d-flex flex-stack mb-2">
									<label class="form-label fw-bolder text-light fs-6 mb-0">Key</label>
								</div>
	...
	if (isset($_POST['login'])) {
		...
		if ($KeyAuthApp->login($_POST['username'], $_POST['password'])) {
			echo "<meta http-equiv='Refresh' Content='2; url=/colo/colo.html'>";
			echo '
